 ...
 */
export declare function validate(value: ValidateValue, token: Text, signData: SignDataSyncFn, options?: ValidateOptions): void | never;
/**
 * Validates passed init data.
 * @param value - value to check.
 * @param token - bot secret token.
 ...
 * @throws {Error} ERR_EXPIRED
 */
export declare function validate(value: ValidateValue, token: Text, signData: SignDataAsyncFn, options?: ValidateOptions): Promise<void>;
